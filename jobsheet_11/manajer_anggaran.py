...
class AnggaranHarian:
    ...
    def get_semua_transaksi_obj(self) -> list:
        """Mengembalikan semua transaksi sebagai list objek Transaksi."""
        sql = (
    ...
    def get_dataframe_transaksi(self, filter_tanggal: datetime.date | None = None) -> pd.DataFrame:
        """Mengembalikan data transaksi sebagai DataFrame (untuk ditampilkan di UI)."""
    ...
    def hitung_total_pengeluaran(self, tanggal: datetime.date | None = None) -> float:
        """Menghitung total seluruh pengeluaran (opsional: filter per tanggal)."""
    ...
    def get_pengeluaran_per_kategori(self, tanggal: datetime.date | None = None) -> dict:
        """Mengembalikan dict {kategori: total_jumlah} (opsional: filter per tanggal)."""
        hasil = {}
    ...
    def hapus_transaksi(self, id_transaksi: int) -> bool:
        ...
        # execute_query mengembalikan lastrowid (0 untuk DELETE) atau None jika error
